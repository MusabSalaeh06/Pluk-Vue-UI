                ...
                <div class="w-screen-fit">
                  <div class="w-full p-5">
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
                              ...
                              <select class=" text-gray-700 dark:text-gray-400 block w-full mt-1 text-xl  form-input " v-model="cc_id">
                                <option v-for="rows in cocate"  v-bind:key="rows.id" :value="rows.cc_id">{{rows.name}}</option>
                              </select>
                              </label>
                      <label class="block text-sm">
                      ...
                      <span class="text-gray-700 dark:text-gray-400">ประเภทรายวิชา</span>
                        <select class=" text-gray-700 dark:text-gray-400 block w-full mt-1 text-xl  form-input " v-model="course_type">
                      ...
                      <span class="text-gray-700 dark:text-gray-400">สถานะรายวิชา</span>
                        <select class=" text-gray-700 dark:text-gray-400 block w-full mt-1 text-xl  form-input " v-model="course_status">
                          <option value="เผยแพร่">เผยแพร่</option>
                          <option value="ซ่อน">ซ่อน</option>
                        </select>
                      </label>
                      <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">ติวเตอร์ประจำรายวิชา</span>
...
import Swal from 'sweetalert2';
  ...
  export default {
    ...
    methods: {
      ...
      this.submitted = true;
      e.preventDefault();  
            axios.post('http://elearning-its.test/api/course/store', {
                    cc_id:this.cc_id,  
