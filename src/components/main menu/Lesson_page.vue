            ...
            <div class="col-span-5">
                <div class="lg:w-full px-4 md:px-0">
                    ...
                    <div v-show="tab === 6">
                        ...
                        <!-- <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <div class="text-2xl text-gray-600 dark:text-gray-400">
                                <b><box-icon class="pt-1 " name='detail' type='solid'></box-icon>ทำความรู้จัก Vue.js เบื้องต้น</b> <br>
                        ...
                        <div class="overflow-x-auto relative shadow-md sm:rounded-lg px-4 py-3 mb-8">
                            <b>
                                <box-icon class="pt-1 " name='detail' type='solid'></box-icon>ทำความรู้จัก Vue.js
                                เบื้องต้น
                            </b> <br>
                            <table class="w-full text-xl text-left text-gray-500 dark:text-gray-400 rounded-lg">
                                <tbody>
                                    <tr
                                        class="dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td class="py-4 px-6" width="90%">
                                            ปัจจุบัน Vue.js เป็นหนึ่งใน Web Framework ที่คนนิยมนำมาพัฒนาเว็บไซต์ (3
                                            เจ้าใหญ่ๆ คือ
                                            React, Vue, Angular นั่นเอง)
                                            วันนี้ผมจะมาทำ Tutorial อธิบายว่า Vue.js คืออะไร? ไปจนถึงสอนวิธีการใช้งาน
                                            Vue.js
                                            ตั้งแต่เริ่มต้น เข้าใจ
                                            Concept ภาพรวม จนจบบทความ ทุกคนสามารถสร้างเว็บไซต์ได้เองโดยใช้ Vue.js
                                        </td>
                                        <td class="py-4 px-6 text-rigth" width="5%">
                                            <button class="bg-yellow-500 shadow-lg text-white p-1 rounded-lg">แก้ไข</button>
                                        </td>
                                        <td class="py-4 px-6 text-rigth" width="5%">
                                            <button class="bg-red-500 shadow-lg text-white p-1 rounded-lg">ลบ</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <td class="py-4 px-6" width="90%">
                                            <a :href="rows.link" target="_blank">
                                                <button type="button"
                                                    class="p-4 bg-blue-500 text-white shadow-md rounded-md hover:bg-red-700">
                                                    <h5>กดที่นี่เพื่อไปที่ลิงค์</h5>
                                                </button>
                                            </a>
                                        </td>
                                        <td class="py-4 px-6 text-rigth" width="5%">
...
export default {
    ...
    methods: {
        ...
        getCourseDetail() {
            axios.get('http://elearning-its.test/api/lesson/page/' + this.$route.params.id).then((response) => {
