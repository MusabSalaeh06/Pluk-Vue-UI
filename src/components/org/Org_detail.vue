                        ...
                        <form action="/course_show">
                            <div class="flex float-right  mb-3">
                                <div class="relative w-full max-w-xl mr-0 focus-within:text-purple-500">
                                    ...
                                    <input
                                        class="w-full pl-10 py-3 pr-2 text-xl text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input"
                                        type="text" placeholder="ค้นหา..." aria-label="Search" />
                                </div>
                                <button
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-semibold  px-2 rounded">ค้นหา</button>
                            </div>
                        </form>
                                ...
                                <table class="w-full whitespace-no-wrap">
                                    ...
                                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                        <tr class="text-gray-700 dark:text-gray-400" v-for="rows in course"
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">ดรอป</button>
                                            </td>
                                        </tr>
                                        ...
                                        <!-- <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded"
                                                    type="button" v-on:click="enrollModal()">ลงทะเบียน</button>
                                ...
                                <table class="w-full whitespace-no-wrap">
                                    <thead>
                                        <tr
                                            ...
                                            <th class="px-4 py-6" colspan="2" width="10%"></th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                        <tr class="text-gray-700 dark:text-gray-400" v-for="rows in member_in_org_inv"
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">แชท</button>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <button
                            ...
                            <div class="w-full overflow-x-auto">
                                <table class="w-full whitespace-no-wrap">
                                    <thead>
                                        <tr
                                            class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-100 dark:text-gray-400 dark:bg-gray-800">
                                            <th class="px-4 py-6">ว/ด/ป ขอเข้าร่วม</th>
                                            <th class="px-4 py-6">ชื่อผู้ขอเข้าร่วม</th>
                                            <th class="px-4 py-6" colspan="2" width="20%"></th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                        <tr class="text-gray-700 dark:text-gray-400" v-for="rows in org_request"
                                            v-bind:key="rows.id">
                                            <td class="px-4 py-3 text-sm">
                                                {{dateTime(rows.created_at)}}
                                            </td>
                            ...
                            <div class="w-full overflow-x-auto">
                                <table class="w-full whitespace-no-wrap">
                                    <thead>
                                        <tr
                                            class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-100 dark:text-gray-400 dark:bg-gray-800">
                                            <th class="px-4 py-6">ชื่อผู้ใช้งาน</th>
                                            <th class="px-4 py-6" colspan="1" width="15%"></th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                        <tr class="text-gray-700 dark:text-gray-400" v-for="rows in member"
                                            v-bind:key="rows.id">
                                            <td class="px-4 py-3 text-sm">
                                                {{rows.name}} {{rows.surname}}
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-green-500 w-full hover:bg-green-700 text-white font-bold py-2 px-4 rounded">เชิญ</button>
                                            </td>
                                        </tr>
                                        <tr class="text-gray-700 dark:text-gray-400" v-for="rows in member_join"
                                            v-bind:key="rows.id">
                                            <td class="px-4 py-3 text-sm">
                                                {{rows.name}} {{rows.surname}}
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-gray-500 w-full text-white font-bold py-2 px-4 rounded-md shadow-lg">เข้าร่วมเเล้ว</button>
                                            </td>
                                        </tr>
                                        <tr class="text-gray-700 dark:text-gray-400" v-for="rows in member_request"
                                            v-bind:key="rows.id">
                                            <td class="px-4 py-3 text-sm">
                                                {{rows.name}} {{rows.surname}}
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-gray-500 w-full text-white font-bold py-2 px-4 rounded-md shadow-lg">ขอเข้าร่วมเเล้ว</button>
                                            </td>
                                        </tr>
                                        <tr class="text-gray-700 dark:text-gray-400" v-for="rows in member_invite"
                                            v-bind:key="rows.id">
                                            <td class="px-4 py-3 text-sm">
                                                {{rows.name}} {{rows.surname}}
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-gray-500 w-full text-white font-bold py-2 px-4 rounded-md shadow-lg">เชิญเเล้ว</button>
                                            </td>
                                        </tr>
                                        <tr class="text-gray-700 dark:text-gray-400" v-for="rows in member_owner"
                                            v-bind:key="rows.id">
                                            <td class="px-4 py-3 text-sm">
                                                {{rows.name}} {{rows.surname}}
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-gray-500 w-full text-white font-bold py-2 px-4 rounded-md shadow-lg">รายวิชาที่ฉันเปิดสอน</button>
                                            </td>
                                        </tr>
                                        <!-- <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <button
                                                    class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">เชิญ</button>
                                            </td>
                                        </tr> -->
                                    </tbody>
                                </table>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <button @click="activeTabFour"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">คำขอเข้าร่วม</span>
                                <span
                                    class="inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-blue-600 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-200">
                                    {{org_r_count}}</span>
                            </button>
                        ...
                        <li>
                            <button @click="activeTabFive"
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">เชิญ</span>
                            </button>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    export default {
        ...
        // async mounted() {
        //             const resourse = await axios.get('http://elearning-its.test/api/detail/my_org/'+this.$route.params.id)
        //         //console.log(resourse)
        //         //axios.get('http://elearning-its.test/api/detail/my_org/3').then((response) => {
        //             this.org_name = resourse.data.data_org.org_name;
        //             this.org_tel = resourse.data.data_org.org_tel;
        //             this.org_owner = resourse.data.data_org.org_owner;
        //             this.county = resourse.data.data_org.county;
        //             this.road = resourse.data.data_org.road;
        //             this.alley = resourse.data.data_org.alley;
        //             this.house_number = resourse.data.data_org.house_number;
        //             this.group_no = resourse.data.data_org.group_no;
        //             this.sub_district = resourse.data.data_org.sub_district;
        //             this.district = resourse.data.data_org.district;
        //             this.province = resourse.data.data_org.province;
        //             this.ZIP_code = resourse.data.data_org.ZIP_code;
        //             this.description = resourse.data.data_org.description;
